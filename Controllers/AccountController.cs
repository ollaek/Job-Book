...
namespace Job_Book.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.RoleViewModels.Where(a => !a.Name.Contains("admin")).ToList(), "Name", "Name");
            return View();
        }
...

        {
            ...
            {
                ViewBag.Message = "inCorrectPassword";
            }
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "Your profile is Edited";
